...
public class RSACertServiceImpl implements CertService {
    @Override
    public String[] selfIssueSingleCert(SelfIssueCertVO vo) {
        try {
            ...
            Certificate cert = CertUtil.selfIssueCert(isCa, true, true, dn, notBefore, notAfter, sans, keyPair, RSA.SIGNATURE_SHA256_WITH_RSA);
            ...
            throw new RuntimeException("自签发RSA证书失败", e);
        }
    }
    ...
    public String caIssueSingleCert(CaIssueCertVO vo) {
        try {
            ...
            Certificate cert = CertUtil.caIssueCert(isCa, true, true, subjectDn, subjectPublicKey, notBefore, notAfter, issuerDn, sans, CertUtil.extraPublicKey(caCert), issuerPrivateKey, RSA.SIGNATURE_SHA256_WITH_RSA);
